@echo off
title Nyxeris Storefront ^& Dropshipping Engine
cd /d "%~dp0"

echo ======================================================================
echo           NYXERIS - PHYSICAL HARDWARE ^& DROPSHIPPING PLATFORM
echo ======================================================================
echo.
...
echo [*] Starting Nyxeris Local Server at http://localhost:8000 ...
echo [*] Storefront: http://localhost:8000
echo [*] Dropshipping Cockpit: http://localhost:8000/admin
echo.
